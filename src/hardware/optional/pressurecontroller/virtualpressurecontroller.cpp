...
VirtualPressureController::VirtualPressureController(QObject *parent) : PressureController(BC::Key::hwVirtual,BC::Key::vpcName,CommunicationProtocol::Virtual,false,parent)
{
}
