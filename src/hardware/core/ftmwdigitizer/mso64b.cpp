    ...
    d_headerNumBytes(0), d_waveformBytes(0)
{
    ...
    setDefault(minFullScale,5e-3);
    setDefault(maxFullScale,5.0);
    setDefault(minVOffset,-5.0);
    setDefault(maxVOffset,5.0);
    ...
    setDefault(maxRecordLength,62500000);
