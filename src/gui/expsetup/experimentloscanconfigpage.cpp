    ...
    : ExperimentConfigPage(key,title,exp,parent)
{
    ...
    connect(p_constantDownOffsetBox,&QCheckBox::toggled,this,&ExperimentLOScanConfigPage::constantOffsetChanged);
    connect(p_fixedDownLoBox,&QCheckBox::toggled,this,&ExperimentLOScanConfigPage::fixedChanged);
...
void ExperimentLOScanConfigPage::startChanged(RfConfig::ClockType t, double val)
{
    if(!p_exp->ftmwConfig())
        return;
...
void ExperimentLOScanConfigPage::endChanged(RfConfig::ClockType t, double val)
{
    if(!p_exp->ftmwConfig())
        return;
...
void ExperimentLOScanConfigPage::minorStepChanged(RfConfig::ClockType t, int val)
{
    Q_UNUSED(t)
...
void ExperimentLOScanConfigPage::minorStepSizeChanged(RfConfig::ClockType t, double val)
{
    if(!p_exp->ftmwConfig())
        return;
...
void ExperimentLOScanConfigPage::majorStepChanged(RfConfig::ClockType t, int val)
{
    Q_UNUSED(t)
...
void ExperimentLOScanConfigPage::majorStepSizeChanged(RfConfig::ClockType t, double val)
{
    double start = p_upStartBox->value();
    double end = p_upEndBox->value();
...
void ExperimentLOScanConfigPage::fixedChanged(bool fixed)
{
...
void ExperimentLOScanConfigPage::constantOffsetChanged(bool co)
{
...
double ExperimentLOScanConfigPage::calculateMajorStepSize(RfConfig::ClockType t)
{
    if(t == RfConfig::UpLO)
    {
...
ExperimentLOScanConfigPage::LoRanges ExperimentLOScanConfigPage::calculateLoRanges() const
{
    if(!p_exp->ftmwConfig())
...
bool ExperimentLOScanConfigPage::validate()
{
    if(!isEnabled() || !p_exp->ftmwConfig())
        return true;
...
void ExperimentLOScanConfigPage::apply()
{
    if(!isEnabled() || !p_exp->ftmwConfig())
        return;
