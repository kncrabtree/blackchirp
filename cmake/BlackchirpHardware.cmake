...
# Generate hw_h.h content
set(HW_H_CONTENT "// Generated by CMake - do not edit manually\n")

# Add hardware type base classes first
foreach(HEADER ${HARDWARE_TYPE_HEADERS})
    file(RELATIVE_PATH REL_HEADER ${CMAKE_CURRENT_SOURCE_DIR}/src ${HEADER})
    set(HW_H_CONTENT "${HW_H_CONTENT}#include \"${REL_HEADER}\"\n")
endforeach()

# Add hardware implementations
